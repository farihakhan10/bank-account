...
public class SwaggerConfig {
    ...
    public static final Contact DEFAULT_CONTACT = new Contact("Fariha.Khan", "", "fariha.khan10@outlook.com");
    private static final Set<String> DEFAULT_PRODUCES_AND_CONSUMES = new HashSet<>(Arrays.asList("application/json",
            "application/xml"));

    static {
        DEFAULT_API_INFO = new ApiInfo("Bank Account", "User Api Documentation", "1.0",
